...
-- Insert some sample data with proper timestamp format
INSERT INTO public."Event" (title, description, date, time, location, category, participants, max_participants, distance) VALUES
('Morning Yoga', 'Start your day with gentle yoga exercises', '2025-01-15'::timestamp, '2025-01-15 07:00:00'::timestamp, 'Community Park', 'Health & Wellness', 12, 20, '0.5 km'),
('Health Checkup', 'Comprehensive health screening for seniors', '2025-01-16'::timestamp, '2025-01-16 10:00:00'::timestamp, 'Senior Center', 'Healthcare', 8, 15, '1.2 km'),
('Social Gathering', 'Connect with fellow community members', '2025-01-17'::timestamp, '2025-01-17 15:00:00'::timestamp, 'Community Hall', 'Social', 25, 30, '0.8 km')
