...
const translations = {
  ...
  hi: {
    ...
    overdue: 'देर से',
    // Medicine Reminders specific
    stayHealthy: 'अपनी दवा के शेड्यूल से स्वस्थ रहें',
    ...
    reminderSkipped: 'रिमाइंडर छोड़ा गया',
    skip: 'छोड़ें',
    error: 'त्रुटि',
  ...
  ne: {
    ...
    overdue: 'ढिलो भएको',
    // Medicine Reminders specific
    stayHealthy: 'तपाईंको औषधि तालिकासँग स्वस्थ रहनुहोस्',
    ...
    selectFrequency: 'आवृत्ति चुन्नुहोस्',
    ...
    medicineTaken: 'औषधि खाइयो',
    markedAsTaken: 'खाएको चिन्ह लगाइयो',
